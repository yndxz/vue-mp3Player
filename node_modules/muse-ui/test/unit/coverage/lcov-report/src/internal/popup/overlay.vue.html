...
<html lang="en">
<head>
    <title>Code coverage report for src/internal/popup/overlay.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">src/internal/popup/</a> overlay.vue
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      e</span>vent.stopPropagation()
    ...
    handleClick () {
<span class="cstat-no" title="statement not covered" >      if (this.onClick) {</span>
<span class="cstat-no" title="statement not covered" >        t</span>his.onClick()
      }
    }
  }
}
