...
<html lang="en">
<head>
    <title>Code coverage report for src/raisedButton/raisedButton.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/raisedButton/</a> raisedButton.vue
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      r</span>eturn {
    ...
    inverse () {
<span class="cstat-no" title="statement not covered" >      r</span>eturn this.primary || this.secondary || this.backgroundColor
    },
    buttonClass () {
<span class="cstat-no" title="statement not covered" >      r</span>eturn {
...
<span class="cstat-no" title="statement not covered" >      t</span>his.focus = isFocus
<span class="cstat-no" title="statement not covered" >      t</span>his.$emit('keyboardFocus', isFocus)
    },
    handleHover (e) {
<span class="cstat-no" title="statement not covered" >      t</span>his.$emit('hover', e)
    },
    handleHoverExit (e) {
<span class="cstat-no" title="statement not covered" >      t</span>his.$emit('hoverExit', e)
    }
  },
  components: {
