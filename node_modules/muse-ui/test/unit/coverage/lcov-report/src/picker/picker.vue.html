...
<html lang="en">
<head>
    <title>Code coverage report for src/picker/picker.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/picker/</a> picker.vue
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        r</span>eturn []
    ...
    slots: <span class="fstat-no" title="function not covered" >{</span>
      type: Array,
      default () {
<span class="cstat-no" title="statement not covered" >        r</span>eturn []
      }
  ...
  methods: <span class="fstat-no" title="function not covered" >{</span>
    change (index, args) {
<span class="cstat-no" title="statement not covered" >      t</span>his.$emit('change', args[0], index)
    }
  },
  components: {
