...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import './styles/base.less'
import Vue from 'vue'
...
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof window !== 'undefined' &amp;&amp; window.Vue) <span class="cstat-no" title="statement not covered" >i</span>nstall(window.Vue)
&nbsp;
module.exports = {
  ...components,
  install
