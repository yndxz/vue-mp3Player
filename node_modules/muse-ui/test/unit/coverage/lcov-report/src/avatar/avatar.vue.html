...
<html lang="en">
<head>
    <title>Code coverage report for src/avatar/avatar.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/avatar/</a> avatar.vue
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      t</span>his.$emit('click')
  ...
  created () {
<span class="cstat-no" title="statement not covered" >    t</span>his._isAvatar = true
  },
  components: {
    icon
  }
