...
<html lang="en">
<head>
    <title>Code coverage report for src/snackbar/snackbar.vue</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/snackbar/</a> snackbar.vue
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    r</span>eturn {
  ...
  methods: <span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" >{</span></span>
    clickOutSide () {
<span class="cstat-no" title="statement not covered" >      t</span>his.$emit('close', 'clickOutSide')
    },
    handleActionClick () {
<span class="cstat-no" title="statement not covered" >      t</span>his.$emit('actionClick')
    }
  },
  components: {
