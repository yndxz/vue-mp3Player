...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/translate.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/utils/</a> translate.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var docStyle = document &amp;&amp; document.documentElement.style
var engine
var translate3d = false
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>i</span>f (window !== undefined &amp;&amp; window.opera &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >Object.prototype.toString.call(window.opera) === '[object Opera]') {
...
<span class="cstat-no" title="statement not covered" >  v</span>ar matches = /translate\(\s*(-?\d+(\.?\d+?)?)px,\s*(-?\d+(\.\d+)?)px\)\s*translateZ\(0px\)/g.exec(transform)
